...
class AutoUpdater_Backuptool
{
     ...
     * @param array       $options
     * @param string|bool $customURL
     *
     * @return array
     *
     * @throws Exception
     */
    public function install($installation_dir, $login, $password, $secret, $max_backup_id, $options = array(), $customURL = false)
    {
        ...
        $download_url = $customURL ? $customURL : AutoUpdater_Config::getAutoUpdaterUrl()
            . 'download/backuptool/autoupdater.zip?php_version=' . phpversion();
     ...
     * @return array
     */
    public function setup($backup_dir, $login = null, $password = null, $secret = null, $max_backup_id = null, $options = array())
    {
        if (version_compare(PHP_VERSION, '5.3', '<'))
        {
            return array(
